                                ...
                                return (
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="headingOne">
                                            <button className="accordion-button pt-3 p-2" type="button" data-bs-toggle="collapse" data-bs-target={`#collapseOne${i}`} aria-expanded="true" aria-controls="collapseOne" style={{ fontSize: "14px", fontWeight: "600", color: "white !important" }}>
                                                {items.question}
                                            </button>
                                        </h2>
